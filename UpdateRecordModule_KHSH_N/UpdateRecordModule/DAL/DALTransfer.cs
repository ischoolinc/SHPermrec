    ...
    public class DALTransfer
    {
        ...
        public static XElement ConvertStudUpdateRecDocToXML(List<BL.StudUpdateRecDoc> updateRecList)
        {
          ...
          //var data = from ud in updateRecList orderby;
            Dictionary<string, List<BL.StudUpdateRecDoc>> data = new Dictionary<string, List<UpdateRecordModule_KHSH_N.BL.StudUpdateRecDoc>>();
            Dictionary<string, string> deptCodeDict = new Dictionary<string, string>();
            ...
            {                                
                ...
                {
                    List<BL.StudUpdateRecDoc> xx = new List<UpdateRecordModule_KHSH_N.BL.StudUpdateRecDoc>();
                    xx.Add(val);
                    data.Add(key, xx);
                }
            }
        ...
        public static BL.StudUpdateRecBatchRec GetStudUpdateRecBatchRec(string ID)
        {
            ...
            BL.StudUpdateRecBatchRec surbr = new UpdateRecordModule_KHSH_N.BL.StudUpdateRecBatchRec();
