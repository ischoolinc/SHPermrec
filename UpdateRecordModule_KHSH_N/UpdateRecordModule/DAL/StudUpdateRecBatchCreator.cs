...
namespace UpdateRecordModule_KHSH_N.DAL
{
    ...
    {
        public enum UpdateRecBatchType { 新生名冊, 畢業名冊, 轉學生入學名冊, 復學生名冊, 轉出學生名冊, 延修學生名冊 }
        ...
        {                      
            _StudUpdateRecDocList = new List<UpdateRecordModule_KHSH_N.BL.StudUpdateRecDoc>();        
        }
        ...
        {
            int sy, ss;
            BL.StudUpdateRecBatchRec StudUpdateRecBRec = new UpdateRecordModule_KHSH_N.BL.StudUpdateRecBatchRec();
