...
using UpdateRecordModule_KHSH_N.UpdateRecordItemControls;
...
namespace UpdateRecordModule_KHSH_N
{
    ...
    public partial class UpdateRecordItemForm : FISCA.Presentation.Controls.BaseForm
    {
        ...
        // Log
        private UpdateRecordModule_KHSH_N.PermRecLogProcess _prlp;
        ...
        public UpdateRecordItemForm(actMode mode, SHUpdateRecordRecord StudUdRecEnty,string StudentID)
        {
            ...
            _prlp = new UpdateRecordModule_KHSH_N.PermRecLogProcess();
