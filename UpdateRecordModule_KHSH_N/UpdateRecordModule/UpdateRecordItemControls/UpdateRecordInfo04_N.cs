...
{
    public partial class UpdateRecordInfo04_N : UserControl, IUpdateRecordInfo
    {
        // 異動
        ...
        /// 畢業異動
        /// </summary>
        public UpdateRecordInfo04_N(SHUpdateRecordRecord UpdateRec, PermRecLogProcess prlp, List<XElement> UpdateCodeElms)
        {
            InitializeComponent();
