...
namespace UpdateRecordModule_KHSH_N.UpdateRecordItemControls
{
    ...
    public partial class UpdateRecordInfo03_N : UserControl, IUpdateRecordInfo
    {
        // 異動
        ...
        /// 新生異動
        /// </summary>
        public UpdateRecordInfo03_N(SHUpdateRecordRecord UpdateRec, PermRecLogProcess prlp, List<XElement> UpdateCodeElms)
        {
            InitializeComponent();
            ...
            _faldn = new UpdateRecordModule_KHSH_N.Utility.FormAndLogDataManager(_prlp);
            ...
            txtGradeComment = _faldn.SetFormData(_UpdateRec.GraduateComment, txtGradeComment, "註2(入學資格註記)");
        ...
        SHUpdateRecordRecord IUpdateRecordInfo.GetStudUpdateRecord()
        {
            ...
            _UpdateRec.GraduateComment = _faldn.GetFormData(txtGradeComment, "註2(入學資格註記)");
        ...
        {
            if (int.Parse(cbxUpdateCode.Text) > 5)
                txtGradeComment.Text = "1";
            else
        ...
        {
            Utility.SchoolListForm sf = new UpdateRecordModule_KHSH_N.Utility.SchoolListForm(Utility.SchoolListForm.LoadSchoolType.國中);
