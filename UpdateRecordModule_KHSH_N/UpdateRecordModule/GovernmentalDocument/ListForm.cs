...
using UpdateRecordModule_KHSH_N.BL;
using System.IO;
...
namespace UpdateRecordModule_KHSH_N.GovernmentalDocument
{
    public partial class ListForm : FISCA.Presentation.Controls.BaseForm
    {
        ...
        // 畫面上選擇的異動名冊
        UpdateRecordModule_KHSH_N.BL.StudUpdateRecBatchRec _SelectBRec;
        // 畫面上選擇的異動名冊ID
        ...
        {
            // 取得異動名冊畫面上所選擇異動名冊ID
            _SelectBRecID = UpdateRecordModule_KHSH_N.BL.Get.UpdateBatchSelectID();
            // 透過異動名冊ID取得異動名冊
            _SelectBRec = UpdateRecordModule_KHSH_N.BL.Get.StudUpdateRecBatchRecByID(_SelectBRecID);
