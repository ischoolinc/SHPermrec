...
namespace UpdateRecordModule_KHSH_N.GovernmentalDocument
{
    public partial class BuildWizard : FISCA.Presentation.Controls.BaseForm 
    {
        ...
        DAL.StudUpdateRecBatchCreator _StudUpdateRecBatchCreator = new UpdateRecordModule_KHSH_N.DAL.StudUpdateRecBatchCreator ();
        ...
        {
            List<BL.StudUpdateRecDoc> list = new List<UpdateRecordModule_KHSH_N.BL.StudUpdateRecDoc>();
