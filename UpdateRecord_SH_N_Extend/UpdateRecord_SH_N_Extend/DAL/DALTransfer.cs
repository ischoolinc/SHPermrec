...
namespace UpdateRecord_SH_N_Extend.DAL
{
    ...
    public class DALTransfer
    {
        ...
        {
            return XElement.Parse(Properties.Resources.UpdateCode_SHN);
        }
        ...
        {
            List<BL.StudUpdateRecDoc> StudRecList = new List<UpdateRecord_SH_N_Extend.BL.StudUpdateRecDoc>();
            ...
            {
                BL.StudUpdateRecDoc studUrec = new UpdateRecord_SH_N_Extend.BL.StudUpdateRecDoc();
        ...
        {
            List<BL.StudUpdateRecDoc> retVal = new List<UpdateRecord_SH_N_Extend.BL.StudUpdateRecDoc>();
            ...
            foreach (XElement d1Elm in dataElms)
            {
                ...
                {
                    BL.StudUpdateRecDoc studUpdateRec = new UpdateRecord_SH_N_Extend.BL.StudUpdateRecDoc();
        ...
        public static XElement ConvertStudUpdateRecDocToXML(List<BL.StudUpdateRecDoc> updateRecList)
        {
          ...
          //var data = from ud in updateRecList orderby;
            Dictionary<string, List<BL.StudUpdateRecDoc>> data = new Dictionary<string, List<UpdateRecord_SH_N_Extend.BL.StudUpdateRecDoc>>();
            Dictionary<string, string> deptCodeDict = new Dictionary<string, string>();
            ...
            {                                
                ...
                {
                    List<BL.StudUpdateRecDoc> xx = new List<UpdateRecord_SH_N_Extend.BL.StudUpdateRecDoc>();
                    xx.Add(val);
                    data.Add(key, xx);
                }
            }
        ...
        public static BL.StudUpdateRecBatchRec GetStudUpdateRecBatchRec(string ID)
        {
            ...
            BL.StudUpdateRecBatchRec surbr = new UpdateRecord_SH_N_Extend.BL.StudUpdateRecBatchRec();
