...
namespace UpdateRecord_SH_N_Extend.Export
{
    ...
    /// 匯出新生異動
    /// </summary>
    public class ExportEnrollmentListOld:SmartSchool.API.PlugIn.Export.Exporter 
    {
        /// <summary>
        /// 可匯出項目
        /// </summary>
        ...
        public ExportEnrollmentListOld()
        {
            this.Image = null;
            this.Text = "匯出新生異動(舊進校)";
