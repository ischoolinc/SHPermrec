...
namespace UpdateRecord_SH_N_Extend.Export
{
    /// <summary>
    /// 匯出畢業異動
    /// </summary>
    public class ExportGraduateListOld : SmartSchool.API.PlugIn.Export.Exporter
    {
        /// <summary>
        /// 可匯出項目
        /// </summary>
        ...
        public ExportGraduateListOld()
        {
            this.Image = null;
            this.Text = "匯出畢業異動(舊進校)";
        ...
        public override void InitializeExport(SmartSchool.API.PlugIn.Export.ExportWizard wizard)
        {
            ...
            wizard.ExportPackage += delegate(object sender, SmartSchool.API.PlugIn.Export.ExportPackageEventArgs e)
            {
                ...
                List<string> UpdateCodeList = (from elm in _UpdateCode.Elements("異動") where elm.Element("分類").Value == "畢業異動" select elm.Element("代號").Value).ToList();
                // 取得學生畢業異動
