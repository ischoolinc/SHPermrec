...
namespace UpdateRecord_SH_N_Extend.UpdateRecordItemControls
{
    public partial class UpdateRecordInfo02_N : UserControl, IUpdateRecordInfo
    {
        ...
        public UpdateRecordInfo02_N(SHUpdateRecordRecord UpdateRec, PermRecLogProcess prlp, List<XElement> UpdateCodeElms)
        {
            ...
            _faldn = new UpdateRecord_SH_N_Extend.Utility.FormAndLogDataManager(_prlp);
        ...
        {
            Utility.SchoolListForm sf = new UpdateRecord_SH_N_Extend.Utility.SchoolListForm(Utility.SchoolListForm.LoadSchoolType.高中);
