...
namespace UpdateRecord_SH_N_Extend.UpdateRecordItemControls
{
    ...
    public partial class UpdateRecordInfo03_N : UserControl, IUpdateRecordInfo
    {
        ...
        public UpdateRecordInfo03_N(SHUpdateRecordRecord UpdateRec, PermRecLogProcess prlp, List<XElement> UpdateCodeElms)
        {
            ...
            _faldn = new Utility.FormAndLogDataManager(_prlp);
        ...
        {
            Utility.SchoolListForm sf = new UpdateRecord_SH_N_Extend.Utility.SchoolListForm(Utility.SchoolListForm.LoadSchoolType.國中);
