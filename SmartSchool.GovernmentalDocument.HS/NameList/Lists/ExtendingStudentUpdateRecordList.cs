    ...
    public class ExtendingStudentUpdateRecordList : ReportBuilder
    {
        protected override void Build(System.Xml.XmlElement source, string location)
        {
            ...
            foreach (XmlElement record in source.SelectNodes("清單/異動紀錄"))
            {
                ...
                mdws.Cells[mdws_index, 3].PutValue("a");
                ...
                mdws.Cells[mdws_index, 9].PutValue(GetBirthdateWithoutSlash(record.GetAttribute("出生年月日")));
                ...
                mdws.Cells[mdws_index, 12].PutValue(GetBirthdateWithoutSlash(record.GetAttribute("異動日期")));
                mdws.Cells[mdws_index, 13].PutValue(GetBirthdateWithoutSlash(record.GetAttribute("備查日期")));
