...
{
    public partial class 曠課七日休學通知單 : BaseForm
    {        //範本設定
        ...
        private void linkLabel1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            ConfigForm_休 configForm = new ConfigForm_休(_useDefaultTemplate1, _buffer1, _useDefaultTemplate2, _buffer2, _useDefaultTemplate3, _buffer3);
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            if ((dateEnd.Value.Year == 1 || dateStart.Value.Year == 1))
            {
        ...
        void _BGWClassStudentMeritDetail_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            foreach (string studentid in lstPrintStu)
            {
                ...
                table.Rows.Add(SchoolYearStr, SemesterStr, (DateTime.Today.Year - 1911) + "年" + DateTime.Today.Month + "月" + DateTime.Today.Day + "日", School.ChineseName, School.Address, School.Telephone, studentid, ClassName, StudentNumber, studentName, DeadlineDate, startDate, endDate, parentsname, zip_code, address);
        ...
        void _BGWClassStudentMeritDetail_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            if (e.Cancelled != true)
            {
                ...
                if (e.Error == null)
                {
                    ...
                    sd.Title = "另存新檔";
                    sd.FileName = "視為休學通知單_7日未到校.docx";
