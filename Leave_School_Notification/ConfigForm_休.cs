...
{
    public partial class ConfigForm_休 : BaseForm
    {
        ...
        public ConfigForm_休(string defaultTemplate1, byte[] buffer1, string defaultTemplate2, byte[] buffer2, string defaultTemplate3, byte[] buffer3)
        {
            InitializeComponent();
