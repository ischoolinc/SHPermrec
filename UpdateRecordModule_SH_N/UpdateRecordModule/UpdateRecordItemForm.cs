...
using UpdateRecordModule_SH_N.UpdateRecordItemControls;
...
namespace UpdateRecordModule_SH_N
{
    ...
    public partial class UpdateRecordItemForm : FISCA.Presentation.Controls.BaseForm
    {
        ...
        // Log
        private UpdateRecordModule_SH_N.PermRecLogProcess _prlp;
        ...
        public UpdateRecordItemForm(actMode mode, SHUpdateRecordRecord StudUdRecEnty,string StudentID)
        {
            ...
            _prlp = new UpdateRecordModule_SH_N.PermRecLogProcess();
