...
namespace UpdateRecordModule_SH_N.Wizards
{
    ...
    public partial class UpdateRecordInfo : UserControl
    {
        ...
        private void DropDownClassType(object sender,bool Expand)
        {
            ...
            cmbClassType.Items.Add(Expand ? "01-核定班" : "01");
        ...
        internal class ChangVisibleDataField
        {
            ...
            {             
                _code_text.Add("301", "更正學號");
                _code_text.Add("302", "更正姓名");
                _code_text.Add("303", "更正性別");
                _code_text.Add("304", "更正身分證號碼");
                _code_text.Add("305", "更正出生年月日");
                _code_text.Add("310", "其他(需說明原因)");
