...
namespace UpdateRecordModule_SH_N
{
    ...
    public class Program
    {
        ...
        /// 高中學籍進校系統核心啟動
        /// </summary>        
        [FISCA.MainMethod("UpdateRecordModule_SH_N")]
        public static void Main()
        {
            ...
            {                
                SmartSchool.API.PlugIn.Export.Exporter exporter = new UpdateRecordModule_SH_N.ImportExport.ExportEnrollmentList();
            ...
            {
                SmartSchool.API.PlugIn.Export.Exporter exporter = new UpdateRecordModule_SH_N.ImportExport.ExportTransferList();
                ImportExport.ExportStudentV2 wizard = new ImportExport.ExportStudentV2(exporter.Text, exporter.Image);
                exporter.InitializeExport(wizard);
                wizard.ShowDialog();
            };
            ...
            {
                SmartSchool.API.PlugIn.Export.Exporter exporter = new UpdateRecordModule_SH_N.ImportExport.ExportStudUpdateRecordList();
                ImportExport.ExportStudentV2 wizard = new ImportExport.ExportStudentV2(exporter.Text, exporter.Image);
                exporter.InitializeExport(wizard);
                wizard.ShowDialog();
            };
            ...
            {
                SmartSchool.API.PlugIn.Export.Exporter exporter = new UpdateRecordModule_SH_N.ImportExport.ExportGraduateList();
                ImportExport.ExportStudentV2 wizard = new ImportExport.ExportStudentV2(exporter.Text, exporter.Image);
                exporter.InitializeExport(wizard);
                wizard.ShowDialog();
            };
        ...
        {
            new UpdateRecordModule_SH_N.Wizards.ChangeInfoProcess(new AccessHelper().StudentHelper.GetSelectedStudent()[0].StudentID).ShowDialog();
        }

        static void btnChangeDept_Click(object sender, EventArgs e)
        {
            new UpdateRecordModule_SH_N.Wizards.ChangeDeptProcess(new AccessHelper().StudentHelper.GetSelectedStudent()[0].StudentID).ShowDialog();
        }
    }
}
