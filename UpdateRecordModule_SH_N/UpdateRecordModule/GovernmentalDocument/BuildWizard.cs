...
namespace UpdateRecordModule_SH_N.GovernmentalDocument
{
    public partial class BuildWizard : FISCA.Presentation.Controls.BaseForm 
    {
        ...
        DAL.StudUpdateRecBatchCreator _StudUpdateRecBatchCreator = new UpdateRecordModule_SH_N.DAL.StudUpdateRecBatchCreator ();
        ...
        {
            List<BL.StudUpdateRecDoc> list = new List<UpdateRecordModule_SH_N.BL.StudUpdateRecDoc>();
