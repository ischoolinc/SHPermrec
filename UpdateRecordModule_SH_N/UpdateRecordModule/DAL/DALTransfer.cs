...
namespace UpdateRecordModule_SH_N.DAL
{
    ...
    public class DALTransfer
    {
        ...
        {
            List<BL.StudUpdateRecDoc> StudRecList = new List<UpdateRecordModule_SH_N.BL.StudUpdateRecDoc>();
            ...
            {
                BL.StudUpdateRecDoc studUrec = new UpdateRecordModule_SH_N.BL.StudUpdateRecDoc();
        ...
        {
            List<BL.StudUpdateRecDoc> retVal = new List<UpdateRecordModule_SH_N.BL.StudUpdateRecDoc>();
            ...
            foreach (XElement d1Elm in dataElms)
            {
                ...
                {
                    BL.StudUpdateRecDoc studUpdateRec = new UpdateRecordModule_SH_N.BL.StudUpdateRecDoc();
        ...
        public static BL.StudUpdateRecBatchRec GetStudUpdateRecBatchRec(string ID)
        {
            ...
            BL.StudUpdateRecBatchRec surbr = new UpdateRecordModule_SH_N.BL.StudUpdateRecBatchRec();
