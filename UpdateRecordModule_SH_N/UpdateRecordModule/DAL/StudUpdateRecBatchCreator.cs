...
namespace UpdateRecordModule_SH_N.DAL
{
    ...
    public class StudUpdateRecBatchCreator
    {
        ...
        {                      
            _StudUpdateRecDocList = new List<UpdateRecordModule_SH_N.BL.StudUpdateRecDoc>();        
        }
        ...
        {
            int sy, ss;
            BL.StudUpdateRecBatchRec StudUpdateRecBRec = new UpdateRecordModule_SH_N.BL.StudUpdateRecBatchRec();
