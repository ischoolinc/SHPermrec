...
using UpdateRecordModule_KHSH_D.BL;
using System.IO;
using UpdateRecordModule_KHSH_D.GovernmentalDocument.Reports.List;
...
namespace UpdateRecordModule_KHSH_D.GovernmentalDocument
{
    public partial class ListForm : FISCA.Presentation.Controls.BaseForm
    {
        ...
        // 畫面上選擇的異動名冊
        UpdateRecordModule_KHSH_D.BL.StudUpdateRecBatchRec _SelectBRec;
        // 畫面上選擇的異動名冊ID
        ...
        {
            // 取得異動名冊畫面上所選擇異動名冊ID
            _SelectBRecID = UpdateRecordModule_KHSH_D.BL.Get.UpdateBatchSelectID();
            // 透過異動名冊ID取得異動名冊
            _SelectBRec = UpdateRecordModule_KHSH_D.BL.Get.StudUpdateRecBatchRecByID(_SelectBRecID);
            ...
            {             
                    ...
                    if (builder == null)
                    {
                        ...
                        FISCA.Presentation.Controls.MsgBox.Show("名冊格式不同，無法列印");
                        return;                    
                    }
                    progressBarX1.Value = 0;
