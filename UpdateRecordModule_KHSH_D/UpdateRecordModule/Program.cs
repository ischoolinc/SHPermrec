...
namespace UpdateRecordModule_KHSH_D
{
    ...
    public class Program
    {
        ...
        /// 高中學籍日校系統核心啟動
        /// </summary>        
        [FISCA.MainMethod("UpdateRecordModule_KHSH_D")]
        public static void Main()
        {
            ...
            {                
                SmartSchool.API.PlugIn.Export.Exporter exporter = new UpdateRecordModule_KHSH_D.ImportExport.ExportEnrollmentList();
            ...
            {
                SmartSchool.API.PlugIn.Export.Exporter exporter = new UpdateRecordModule_KHSH_D.ImportExport.ExportTransferList();
                ImportExport.ExportStudentV2 wizard = new ImportExport.ExportStudentV2(exporter.Text, exporter.Image);
                exporter.InitializeExport(wizard);
                wizard.ShowDialog();
            };
            ...
            {
                SmartSchool.API.PlugIn.Export.Exporter exporter = new UpdateRecordModule_KHSH_D.ImportExport.ExportStudUpdateRecordList();
                ImportExport.ExportStudentV2 wizard = new ImportExport.ExportStudentV2(exporter.Text, exporter.Image);
                exporter.InitializeExport(wizard);
                wizard.ShowDialog();
            };
            ...
            {
                SmartSchool.API.PlugIn.Export.Exporter exporter = new UpdateRecordModule_KHSH_D.ImportExport.ExportGraduateList();
                ImportExport.ExportStudentV2 wizard = new ImportExport.ExportStudentV2(exporter.Text, exporter.Image);
                exporter.InitializeExport(wizard);
                wizard.ShowDialog();
            };
        ...
        {
            new  UpdateRecordModule_KHSH_D.Wizards.ChangeInfoProcess(new AccessHelper().StudentHelper.GetSelectedStudent()[0].StudentID).ShowDialog();
        }

        static void btnChangeDept_Click(object sender, EventArgs e)
        {
            new UpdateRecordModule_KHSH_D.Wizards.ChangeDeptProcess(new AccessHelper().StudentHelper.GetSelectedStudent()[0].StudentID).ShowDialog();
        }
