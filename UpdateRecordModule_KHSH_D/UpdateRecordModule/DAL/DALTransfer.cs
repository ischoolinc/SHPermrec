...
namespace UpdateRecordModule_KHSH_D.DAL
{
    ...
    public class DALTransfer
    {
        ...
        {
            List<BL.StudUpdateRecDoc> StudRecList = new List<UpdateRecordModule_KHSH_D.BL.StudUpdateRecDoc>();
            ...
            {
                BL.StudUpdateRecDoc studUrec = new UpdateRecordModule_KHSH_D.BL.StudUpdateRecDoc();
        ...
        {
            List<BL.StudUpdateRecDoc> retVal = new List<UpdateRecordModule_KHSH_D.BL.StudUpdateRecDoc>();
            ...
            foreach (XElement d1Elm in dataElms)
            {
                ...
                {
                    BL.StudUpdateRecDoc studUpdateRec = new UpdateRecordModule_KHSH_D.BL.StudUpdateRecDoc();
        ...
        public static XElement ConvertStudUpdateRecDocToXML(List<BL.StudUpdateRecDoc> updateRecList)
        {
          ...
          //var data = from ud in updateRecList orderby;
            Dictionary<string, List<BL.StudUpdateRecDoc>> data = new Dictionary<string, List<UpdateRecordModule_KHSH_D.BL.StudUpdateRecDoc>>();
            Dictionary<string, string> deptCodeDict = new Dictionary<string, string>();
            ...
            {                                
                ...
                {
                    List<BL.StudUpdateRecDoc> xx = new List<UpdateRecordModule_KHSH_D.BL.StudUpdateRecDoc>();
                    xx.Add(val);
                    data.Add(key, xx);
                }
            }
        ...
        public static BL.StudUpdateRecBatchRec GetStudUpdateRecBatchRec(string ID)
        {
            ...
            BL.StudUpdateRecBatchRec surbr = new UpdateRecordModule_KHSH_D.BL.StudUpdateRecBatchRec();
        ...
        public static Dictionary<string, StudUpdateRecBatchCreator.UpdateRecBatchType> GetUpdateRecBatchTypeDict()
        {
            ...
            _UpdateRecBatchTypeDict.Add(StudUpdateRecBatchCreator.UpdateRecBatchType.轉學生入學名冊.ToString(), StudUpdateRecBatchCreator.UpdateRecBatchType.轉學生入學名冊);
