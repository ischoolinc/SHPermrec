...
using UpdateRecordModule_SH_D.UpdateRecordItemControls;
...
namespace UpdateRecordModule_SH_D
{
    ...
    public partial class UpdateRecordItemForm : FISCA.Presentation.Controls.BaseForm
    {
        ...
        // Log
        private UpdateRecordModule_SH_D.PermRecLogProcess _prlp;
        ...
        private void btnConfirm_Click(object sender, EventArgs e)
        {
            ...
            if (UpdateRecordEditorPanle.Controls.Count > 0)
            {
                ...
                if (_StudUpdateRec != null)
                {
                    ...
                    if (intUpdateCode >= 310 && intUpdateCode <= 316 && studRec.Status == K12.Data.StudentRecord.StudentStatus.一般)
