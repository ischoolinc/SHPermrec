...
{
    public partial class BatchUpdateRec_WarningForm : FISCA.Presentation.Controls.BaseForm
    {
        ...
        public BatchUpdateRec_WarningForm(Dictionary<string,SHClassRecord> classRec,Dictionary<string,SHStudentRecord> studRec,List<SHUpdateRecordRecord> updateRec)
        {
            InitializeComponent();
        ...
        private void btnView_Click(object sender, EventArgs e)
        {
            ...
            utility.ExportXls("已有重複異動)", wb);
            
        }

        private void BatchGraduateRec_WarningForm_Load(object sender, EventArgs e)
        {
            lblMsg.Text = "有" + _GUpdateRecList.Count + "名學生已有異動。是否新增?";
        }
    }
}
