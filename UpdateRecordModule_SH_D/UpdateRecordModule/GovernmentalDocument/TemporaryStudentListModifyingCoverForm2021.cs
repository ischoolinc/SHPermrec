...
namespace UpdateRecordModule_SH_D.GovernmentalDocument
{
    public partial class TemporaryStudentListModifyingCoverForm2021 : FISCA.Presentation.Controls.BaseForm
    {
        ...
        List<TemporaryStudentListRecCoverRec> coverDataListA = new List<TemporaryStudentListRecCoverRec>();
        ...
        public XElement ConvertStudUpdateRecDocToXML(List<BL.StudUpdateRecDoc> updateRecList)
        {
            ...
            {
                Boolean find = false;
                foreach (TemporaryStudentListRecCoverRec coverRecA in coverDataListA)
