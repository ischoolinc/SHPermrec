...
namespace UpdateRecordModule_SH_D.GovernmentalDocument
{
    public partial class RetaintoStudentListModifyingCoverForm2021 : FISCA.Presentation.Controls.BaseForm
    {
        ...
        List<RetaintoStudentListRecCoverRec> coverDataList = new List<RetaintoStudentListRecCoverRec>();
        List<RetaintoStudentListRecCoverRec> coverDataListA = new List<RetaintoStudentListRecCoverRec>();
        ...
        public XElement ConvertStudUpdateRecDocToXML(List<BL.StudUpdateRecDoc> updateRecList)
        {
            ...
            {
                Boolean find = false;
                foreach (RetaintoStudentListRecCoverRec coverRecA in coverDataListA)
