...
namespace UpdateRecordModule_SH_D.GovernmentalDocument
{
    public partial class TransferingStudentUpdateRecordListModifyingCoverForm2021 : FISCA.Presentation.Controls.BaseForm
    {
        ...
        List<TransferStudUpdateRecCoverRec2021> coverDataList = new List<TransferStudUpdateRecCoverRec2021>();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                TransferStudUpdateRecCoverRec2021 coverData = new TransferStudUpdateRecCoverRec2021();
        ...
        public XElement ConvertStudUpdateRecDocToXML(List<BL.StudUpdateRecDoc> updateRecList)
        {
            ...
            foreach (KeyValuePair<string, List<BL.StudUpdateRecDoc>> val in data)
            {
                ...
                foreach (TransferStudUpdateRecCoverRec2021 coverRec in coverDataList)
                {
