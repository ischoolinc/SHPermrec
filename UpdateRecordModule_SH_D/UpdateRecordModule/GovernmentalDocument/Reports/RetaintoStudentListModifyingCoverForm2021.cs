...
{
    public partial class RetaintoStudentListModifyingCoverForm2021 : FISCA.Presentation.Controls.BaseForm
    {

        StudUpdateRecBatchRec _BRec;

        List<RetaintoStudentListRecCoverRec2021> coverDataList = new List<RetaintoStudentListRecCoverRec2021>();


        //2018/2/5 穎驊新增 提供使用者 可以自行調整 異動名冊封面的資料
        public RetaintoStudentListModifyingCoverForm2021(StudUpdateRecBatchRec BRec)
        {
            InitializeComponent();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                RetaintoStudentListRecCoverRec2021 coverData = new RetaintoStudentListRecCoverRec2021();
        ...
        public XElement ConvertStudUpdateRecDocToXML(List<BL.StudUpdateRecDoc> updateRecList)
        {
            ...
            foreach (KeyValuePair<string, List<BL.StudUpdateRecDoc>> val in data)
            {
                ...
                foreach (RetaintoStudentListRecCoverRec2021 coverRec in coverDataList)
                {
