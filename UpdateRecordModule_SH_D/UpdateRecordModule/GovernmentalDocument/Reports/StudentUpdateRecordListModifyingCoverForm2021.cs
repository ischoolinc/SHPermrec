...
{
    public partial class StudentUpdateRecordListModifyingCoverForm2021 : FISCA.Presentation.Controls.BaseForm
    {

        StudUpdateRecBatchRec _BRec;

        List<StudUpdateRecCoverRec2021> coverDataList = new List<StudUpdateRecCoverRec2021>();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                StudUpdateRecCoverRec2021 coverData = new StudUpdateRecCoverRec2021();
        ...
        public XElement ConvertStudUpdateRecDocToXML(List<BL.StudUpdateRecDoc> updateRecList)
        {
            ...
            foreach (KeyValuePair<string, List<BL.StudUpdateRecDoc>> val in data)
            {
                ...
                foreach (StudUpdateRecCoverRec2021 coverRec in coverDataList)
                {
