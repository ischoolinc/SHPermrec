...
namespace UpdateRecordModule_SH_D.GovernmentalDocument
{
    public partial class ExtendingStudentGraduateListCoverRecModifyingCoverForm2021 : FISCA.Presentation.Controls.BaseForm
    {
        ...
        List<ExtendingStudentGraduateListCoverRec2021> coverDataList = new List<ExtendingStudentGraduateListCoverRec2021>();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                ExtendingStudentGraduateListCoverRec2021 coverData = new ExtendingStudentGraduateListCoverRec2021();
        ...
        public XElement ConvertStudUpdateRecDocToXML(List<BL.StudUpdateRecDoc> updateRecList)
        {
            ...
            foreach (KeyValuePair<string, List<BL.StudUpdateRecDoc>> val in data)
            {
                ...
                foreach (ExtendingStudentGraduateListCoverRec2021 coverRec in coverDataList)
                {
