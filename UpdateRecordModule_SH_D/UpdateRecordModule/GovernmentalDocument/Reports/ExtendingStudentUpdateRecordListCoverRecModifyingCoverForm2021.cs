...
namespace UpdateRecordModule_SH_D.GovernmentalDocument
{
    public partial class ExtendingStudentUpdateRecordListCoverRecModifyingCoverForm2021 : FISCA.Presentation.Controls.BaseForm
    {
        ...
        List<ExtendingStudentUpdateRecordListCoverRec2021> coverDataList = new List<ExtendingStudentUpdateRecordListCoverRec2021>();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                ExtendingStudentUpdateRecordListCoverRec2021 coverData = new ExtendingStudentUpdateRecordListCoverRec2021();
        ...
        public XElement ConvertStudUpdateRecDocToXML(List<BL.StudUpdateRecDoc> updateRecList)
        {
            ...
            foreach (KeyValuePair<string, List<BL.StudUpdateRecDoc>> val in data)
            {
                ...
                foreach (ExtendingStudentUpdateRecordListCoverRec2021 coverRec in coverDataList)
                {
