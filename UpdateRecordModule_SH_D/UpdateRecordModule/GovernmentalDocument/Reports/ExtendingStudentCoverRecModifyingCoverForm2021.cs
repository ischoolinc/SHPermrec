...
namespace UpdateRecordModule_SH_D.GovernmentalDocument
{
    public partial class ExtendingStudentCoverRecModifyingCoverForm2021 : FISCA.Presentation.Controls.BaseForm
    {
        ...
        List<ExtendingStudentCoverRec2021> coverDataList = new List<ExtendingStudentCoverRec2021>();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                ExtendingStudentCoverRec2021 coverData = new ExtendingStudentCoverRec2021();
        ...
        public XElement ConvertStudUpdateRecDocToXML(List<BL.StudUpdateRecDoc> updateRecList)
        {
            ...
            foreach (KeyValuePair<string, List<BL.StudUpdateRecDoc>> val in data)
            {
                ...
                foreach (ExtendingStudentCoverRec2021 coverRec in coverDataList)
                {
