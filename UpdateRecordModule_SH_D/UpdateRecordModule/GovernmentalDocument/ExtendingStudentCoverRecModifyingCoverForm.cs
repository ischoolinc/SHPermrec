...
{
    public partial class ExtendingStudentCoverRecModifyingCoverForm : FISCA.Presentation.Controls.BaseForm
    {
        ...
        public ExtendingStudentCoverRecModifyingCoverForm(StudUpdateRecBatchRec BRec)
        {
            InitializeComponent();
