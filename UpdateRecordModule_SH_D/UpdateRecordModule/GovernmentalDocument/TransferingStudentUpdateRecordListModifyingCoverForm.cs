...
{
    public partial class TransferingStudentUpdateRecordListModifyingCoverForm : FISCA.Presentation.Controls.BaseForm
    {
        ...
        public TransferingStudentUpdateRecordListModifyingCoverForm(StudUpdateRecBatchRec BRec)
        {
            InitializeComponent();
