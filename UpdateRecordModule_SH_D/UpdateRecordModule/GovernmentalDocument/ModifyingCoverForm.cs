...
namespace UpdateRecordModule_SH_D.GovernmentalDocument
{
    public partial class ModifyingCoverForm : FISCA.Presentation.Controls.BaseForm
    {
        ...
        public ModifyingCoverForm(StudUpdateRecBatchRec BRec)
        {
            ...
            switch (_BRec.UpdateType)
            {
                ...
                case "學籍異動名冊":
                    ...
                    #region 加入欄位
                    dataGridViewX1.Columns.Add("學校代碼", "學校代碼");
                    dataGridViewX1.Columns.Add("學年度", "學年度");
                    dataGridViewX1.Columns.Add("學期", "學期");
                    dataGridViewX1.Columns.Add("年級", "年級");
                    dataGridViewX1.Columns.Add("名冊別", "名冊別");
                    dataGridViewX1.Columns.Add("班別", "班別");
                    dataGridViewX1.Columns.Add("科別代碼", "科別代碼");
                    dataGridViewX1.Columns.Add("上傳類別", "上傳類別");
                    dataGridViewX1.Columns.Add("核定班數", "核定班數");
                    dataGridViewX1.Columns.Add("核定學生數", "核定學生數");
                    dataGridViewX1.Columns.Add("實招班數", "實招班數");
                    dataGridViewX1.Columns.Add("實招新生數", "實招新生數");
                    dataGridViewX1.Columns.Add("原有學生數", "原有學生數");
                    dataGridViewX1.Columns.Add("增加學生數", "增加學生數");
                    dataGridViewX1.Columns.Add("減少學生數", "減少學生數");
                    dataGridViewX1.Columns.Add("更正學生數", "更正學生數");
                    dataGridViewX1.Columns.Add("現有學生數", "現有學生數");
                    dataGridViewX1.Columns.Add("註1", "註1");
                    dataGridViewX1.Columns.Add("備註說明", "備註說明");
                    #endregion

                    #region 外觀UI設定
                    // 以下項目不應該讓使用者調整，如果有誤，代表來源就是錯的，應該是去改源頭
                    dataGridViewX1.Columns["學校代碼"].ReadOnly = true;
                    dataGridViewX1.Columns["學年度"].ReadOnly = true;
                    dataGridViewX1.Columns["學期"].ReadOnly = true;
                    dataGridViewX1.Columns["年級"].ReadOnly = true;
                    dataGridViewX1.Columns["名冊別"].ReadOnly = true;
                    dataGridViewX1.Columns["班別"].ReadOnly = true;
                    dataGridViewX1.Columns["科別代碼"].ReadOnly = true;

                    DataGridViewCellStyle style_readonly = new DataGridViewCellStyle();

                    style_readonly.BackColor = Color.LightGray;

                    //不給改的資料 給與灰色 警示使用者
                    dataGridViewX1.Columns["學校代碼"].DefaultCellStyle = style_readonly;
                    dataGridViewX1.Columns["學年度"].DefaultCellStyle = style_readonly;
                    dataGridViewX1.Columns["學期"].DefaultCellStyle = style_readonly;
                    dataGridViewX1.Columns["年級"].DefaultCellStyle = style_readonly;
                    dataGridViewX1.Columns["名冊別"].DefaultCellStyle = style_readonly;
                    dataGridViewX1.Columns["班別"].DefaultCellStyle = style_readonly;
                    dataGridViewX1.Columns["科別代碼"].DefaultCellStyle = style_readonly;

                    //下列資料長度較短，給短寬度
                    dataGridViewX1.Columns["學年度"].Width = 70;
                    dataGridViewX1.Columns["學期"].Width = 60;
                    dataGridViewX1.Columns["年級"].Width = 60;
                    dataGridViewX1.Columns["名冊別"].Width = 70;
                    dataGridViewX1.Columns["班別"].Width = 60;

                    // 最後一項 要隨視窗延展而填滿視窗
                    dataGridViewX1.Columns["備註說明"].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
                    #endregion
                    ...
                    foreach (XmlNode list in source.SelectNodes("清單"))
                    {
                        ...
                        foreach (XmlElement st in list.SelectNodes("異動名冊封面"))
                        {
                            ...
                            //增加學生數
                            row_data.Add(increaseStudentCount);
                            //減少學生數
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            //XmlElement content = new XmlDocument().ReadNode(retVal.CreateReader()) as XmlElement;

            //shurbr.Content = content;
